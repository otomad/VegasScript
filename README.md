...
**English** | [简体中文](https://github.com/otomad/OtomadHelper/blob/winform/README_zh-CN.md) | [繁體中文](https://github.com/otomad/OtomadHelper/blob/winform/README_zh-TW.md) | [日本語](https://github.com/otomad/OtomadHelper/blob/winform/README_ja-JP.md) | [Tiếng Việt](https://github.com/otomad/OtomadHelper/blob/winform/README_vi-VN.md) | [Bahasa Indo](https://github.com/otomad/OtomadHelper/blob/winform/README_id-ID.md)
</div>
...
Ða̵̝̻͔͎͋̇͑̆ƭą̬͉̫̐͑̓̄ͅa̸͎͇͗̌͂̈̀ą̸̝̼̦̤̇̐ǎ̛͍́̑a̸̲͙͛̐̄̎̚͜a̢̨̝̟͎̾̔̊ǎ̤̞͈͑a͈̪̣̍₥o̻̪̬̘̲͆͂͠o̸͍̞͔̓̆̊̀o̗͊̇̇̈́̇ǫ͇͗̏̕͜ơ̬͍͚̦̯̓̊͌ò͈̦̫̈́̓o̦̣̲̊̀o̪̪͚̺̘͛̽̏̈́ƨλ ïƨ á ƭèçλñï9úè ôƒ δá₥áϱïñϱ çℓïƥƨ ƭô çřèáƭè ϱℓïƭçλ¥ èƒƒèçƭƨ. The related features of Datamosh refer to [vegas-datamosh](https://github.com/delthas/vegas-datamosh).
...
3. Make sure that the DLL file `(DLL\NAudio.dll)` is not locked. **Specific steps:**
	...
	3. If you see the "Unblock" button (Windows 7/8.x) or checkbox (Windows 10+), click or check it.
