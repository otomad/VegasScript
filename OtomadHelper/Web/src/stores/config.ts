...
type StartTime = typeof startTimes.keyType;
...
type SelectGeneratedClips = typeof selectGeneratedClipsType.keyType;
type BeepEngine = typeof beepEngines[number];
type TrackNameType = typeof trackNames.keyType;
type BarOrBeatUnit = typeof barOrBeatUnitTypes[number];
type SourceFrom = typeof sourceFromEnums.keyType;
