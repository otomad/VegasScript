export default function ExpanderStreamPlaybackRate({ stream }: FCP<{
	...
	return (
		...
		>
			<ToggleSwitch on={stream === "audio" ? audioBased : visualBased} details={t.descriptions.stream.playbackRate.based} icon="multiply_divide">{t.stream.playbackRate.based}</ToggleSwitch>
