	...
	javascript: {
		...
		prve: {
			...
			effects: {
				...
				rotInvertLumin: "轮流反转，亮度优先",
				altInvertHue: "交替反转，色相优先",
				altInvertLumin: "交替反转，亮度优先",
				hueInvert: "色相反转",
				chromatic: "彩灰",
		...
		descriptions: {
			...
			shupelunker: {
				_: "原音系战法（シュペランカー战法）是一种颠覆传统调音逻辑的音MAD创作手法，核心在于直接利用音频素材的原始音高，通过精准剪辑实现与乐曲旋律的契合。创作时需从素材中筛选出与目标音阶完全匹配的片段，将其按旋律顺序排列，形成类似打击垫的“素材音符化”效果。由于全程不进行调音处理，素材的原始音高必须与乐曲旋律高度一致，因此要求素材库的广度较高。其特色在于通过碎片化剪辑与高速切换，既保留素材原声的真实质感，又营造出类似咒语吟诵的疾走感，尤其适合节奏紧凑、音阶变化丰富的曲目。\n与前者相反，如果素材片段的音高与旋律不匹配，则生成“鞑靼战法”。创作时同样不调音，并通过极致节奏操控实现同步，如切割音频至十六分音符级精度、插入休止符、拉伸或倒放片段，强行将素材节奏与原曲对齐。其灵感源于鼓打贝斯舞曲的碎拍逻辑，通过高频碎片化剪辑制造机械脉冲般的视听冲击。尽管成品内容为“无意义咒语”，却能通过节奏的精密编排产生独特律动感。",
			...
			staff: {
				_: "五线谱可视化是一种将音乐符号转化为创意视觉图形的技术，其核心在于通过自定义图案（如人物头像、几何图形等）替代传统音符，并基于乐曲旋律将其定位在五线谱的对应音高位置上，形成兼具艺术性与功能性的动态画面。这种视觉效果风格的灵感源自数字艺术与音乐的结合实践，YouTube创作者Grant Woolard的作品，他的视频特色是将音乐家头像转化为音符，在五线谱上动态排列，并演奏经典音乐，既保留乐谱的音高逻辑，又赋予其个性化视觉叙事。\n该功能可用于艺术创作与演出视觉设计，例如将音乐家的表演实时转化为动态五线谱艺术投影，或为数字专辑封面生成交互式乐谱动画。其创新性在于打破传统乐谱的静态限制，以视觉语言重新诠释音乐结构，使抽象旋律转化为可感知的“视觉旋律”。",
			},
			prve: {
				control: {
