	...
	javascript: {
		...
		track: {
			...
			legato: {
				...
				limitStretch: "Kéo giãn các clip\nTrong giới hạn kéo giãn",
				stretch: "Kéo giãn các clip\nKéo dài khi nằm ngoài giới hạn kéo giãn",
		...
		descriptions: {
			...
			source: {
				...
				consonant: {
					_: "Để tránh phụ âm bị kéo giãn hoặc chậm trễ, bạn có thể tách phần phụ âm và nguyên âm của cùng một nguồn âm thanh hoặc video để có thể áp dụng tối ưu hóa đặc biệt cho phần phụ âm của nguồn đó.\nNếu chọn ít nhất hai đoạn âm thanh hoặc video, đoạn đầu tiên được coi là phần phụ âm đầu, đoạn thứ hai được coi là phần nguyên âm và đoạn thứ ba (nếu có) được coi là phần phụ âm cuối.",
			...
			stream: {
				stretch: {
					_: "Kéo giãn clip thay vì thay đổi thời lượng của nó",
					noStretching: "Không được kéo giãn, chỉ được thay đổi thời lượng",
					flexingAndExtending: "Kéo giãn bất kể nốt nhạc có dài hơn clip hay không",
					extendingOnly: "Kéo giãn nếu chỉ có nốt nhạc dài hơn clip, nếu không thì rút ngắn thời lượng",
					flexingOnly: "Kéo giãn nếu chỉ có nốt nhạc ngắn hơn clip, nếu không thì kéo dài thời lượng",
				},
				loop: {
				...
				resampleImitatively: {
					_: "Mô phỏng hành vi resampling trong Visual, khiến độ giãn nở cong khi cao độ tăng",
				...
				tuning: {
					tuningMethod: {
						...
						elastic: "Sử dụng Phương pháp thay đổi cao độ Elastic. Phương pháp Élastique sử dụng công nghệ từ zplane.development và cung cấp khả năng kéo giãn thời gian thực và thay đổi cao độ được cải tiến. Đây chỉ là phương pháp mặc định để nhấn trực tiếp các phím +/−.",
						...
						scaleless: "Khóa độ giãn và cao độ, và thay đổi độ giãn để có được cao độ tương ứng bất kể cao độ nốt nhạc thực tế ra sao, chỉ cho vui",
					...
					resample: "Điều chỉnh độ giãn để thay đổi cao độ đồng bộ, khiến độ giãn cong khi cao độ tăng, thể hiện phong cách máy ghi âm băng cổ điển",
